...
<inversion>2-3 段，约 250-400 字。芒格式反向思考（Inversion）—— "想要赢，先想怎么会输"。
请逐一思考下述 10 个致命提问，挑出最相关的 3-5 个具体展开（不是套话，要落到这家公司的具体情况）：

  1. 行业颠覆：是否存在新技术 / 新商业模式正在替代这家公司的核心产品（如 AI 替代搜索、电车替代燃油）？
  2. 监管反转：核心收入是否依赖某条具体政策（牌照、补贴、关税、价格管制），政策反转概率多大？
  3. 客户集中度：前 5 大客户 / 渠道占比超过 30%？大客户流失会怎样？
  4. 供应链脆弱：原材料 / 关键零部件是否只能从一家或一国进口？地缘政治冲击？
  5. 关键人物：创始人 / 灵魂人物离世 / 离职是否会引发组织瓦解（茅台 vs 苹果对比）？
  6. 资产负债表：是否在做"挪坑"会计（应收账款激增 / 商誉激增 / 表外融资）？
  7. 品牌污点：单一食品安全 / 质量门 / 数据泄露 / 高管丑闻是否足以击穿品牌（双汇 vs 海底捞）？
  8. 现金流陷阱：CFO 长期 < 净利 = 应收账款堆积 = 未来减值或坏账（贾跃亭式）？
  9. 杠杆失控：负债率 > 70% 或短债覆盖率 < 1，遇到融资环境收紧会怎样？
 10. 估值崩塌：当前 PE 是否依赖"永续高增长"假设？增速回落到行业均值 PE 会跌多少？

输出格式：列出 3-5 个最相关的具体风险，每个 70-100 字，明确标注可能性（高/中/低）和时间窗（1-3 年 / 3-10 年）。
这是"避免明显的坏"——芒格说："如果我知道我会死在哪里，我就永远不去那里。"</inversion>
